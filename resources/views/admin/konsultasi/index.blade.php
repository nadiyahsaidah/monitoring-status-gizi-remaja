                                ...
                                @foreach ($konsultasis as $konsultasi)
                                    ...
                                    <tr class="{{ $notification ? 'table-warning' : '' }}">
                                        ...
                                        <td>
                                            <div class="d-flex gap-3">
                                                ...
                                                @foreach (Auth::user()->unreadNotifications as $notification)
                                                    <button type="button" class="btn btn-info" data-toggle="modal"
                                                        data-target="#showModal{{ $konsultasi->id }}"
                                                        onclick="markAsRead('{{ $notification->id }}')">Show</button>
                                                @endforeach
                                                @else
                                                    <button type="button" class="btn btn-info" data-toggle="modal"
                                                        data-target="#showModal{{ $konsultasi->id }}">Show</button>
                                                @endif
                                                @if (Auth::user()->role != 'remaja' && $konsultasi->balasan == null)
                                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                                        data-target="#editModal{{ $konsultasi->id }}">Balas</button>
                                            ...
                                            <!-- Modal Show -->
                                            <div class="modal fade" id="showModal{{ $konsultasi->id }}" tabindex="-1"
                                                role="dialog" aria-labelledby="showModalLabel{{ $konsultasi->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="showModalLabel{{ $konsultasi->id }}">Detail Konsultasi
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <p><strong>Nama Remaja:</strong>
                                                                {{ $konsultasi->remaja->user->nama }}</p>
                                                            ...
                                                            <p><strong>Status:</strong>
                                                                @if ($konsultasi->status == 'Belum dibalas')
                                                                    <span
                                                                        class="badge bg-warning text-white">{{ $konsultasi->status }}</span>
                                                                @else
                                                                    <span
                                                                        class="badge bg-success text-white">{{ $konsultasi->status }}</span>
                                                                @endif
                                                            </p>
